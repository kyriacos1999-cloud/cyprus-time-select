...
export const productReviews: Record<number, ProductReview[]> = {
  1: [
    { name: "Andreas K.", city: "Nicosia", rating: 5, date: "2026-02-28", text: "Incredible build quality. The weight and finishing are spot on — my colleagues at work were genuinely shocked when I told them the price. The black dial is stunning in person.", photos: [reviewSubNodate1] },
    { name: "Michalis T.", city: "Limassol", rating: 5, date: "2026-02-15", text: "Bought this as a daily wearer and it hasn't disappointed. The Seiko NH35 movement keeps excellent time. Box presentation was also really impressive.", photos: [reviewSubNodate2] },
    { name: "Stavros P.", city: "Larnaca", rating: 5, date: "2026-01-20", text: "Best purchase I've made this year. Delivered next day, came in a beautiful box with papers. The bracelet clasp feels very secure.", photos: [reviewSubNodate3] },
  ...
  2: [
    { name: "Giorgos M.", city: "Limassol", rating: 5, date: "2026-03-01", text: "The green Hulk is an absolute head-turner. Wore it to a beach bar in Limassol and got three compliments in one evening. The sunburst effect on the dial is beautiful.", photos: [reviewHulk1] },
  ...
  3: [
    { name: "Elena S.", city: "Nicosia", rating: 5, date: "2026-02-25", text: "The perfect dress watch. I wear it daily to the office and it looks absolutely elegant. The fluted bezel catches light beautifully.", photos: [reviewDatejust1] },
  ...
  5: [
    { name: "Alexandros V.", city: "Nicosia", rating: 5, date: "2026-03-05", text: "The Sprite is my favourite watch in the collection. The black and green bezel combo is eye-catching but not over the top. The Jubilee bracelet is incredibly comfortable.", photos: [reviewSprite1] },
  ...
  6: [
    { name: "Petros C.", city: "Nicosia", rating: 5, date: "2026-03-03", text: "The Daytona is in a league of its own. The chronograph pushers feel crisp, the tachymeter bezel is beautifully engraved, and the sub-dials are perfectly aligned. Absolutely worth it.", photos: [reviewDaytona1] },
    { name: "Katerina M.", city: "Limassol", rating: 5, date: "2026-02-14", text: "Valentine's gift for my husband. He literally said it was the best gift he's ever received. The black dial with the contrasting sub-dials is gorgeous.", photos: [reviewDaytona2] },
